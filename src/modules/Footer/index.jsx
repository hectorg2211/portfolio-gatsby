    ...
    return (
        <div className='w-full bg-white'>
            <div className='container m-auto p-10 flex flex-col items-start '>
                ...
                <IconSocial style='transition ease-in-out hover:text-primary hover:scale-150' socialLink='/' icon='fa-brands fa-instagram' size='2x'/>
                <IconSocial style='transition ease-in-out hover:text-primary hover:scale-150' socialLink='/' icon='fa-brands fa-twitter' size='2x'/>
                <IconSocial style='transition ease-in-out hover:text-primary hover:scale-150' socialLink='/' icon='fa-brands fa-linkedin' size='2x'/>
                </div>
