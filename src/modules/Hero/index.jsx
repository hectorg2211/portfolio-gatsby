...
function Hero({title, subtitle, imageSrc, buttonLabel}) {
  return (
    <div className='container m-auto pt-20 pb-6 sm:py-40 flex flex-col items-center md:items-start px-5'>
      <div className='flex w-full flex-col-reverse md:flex-row items-center gap-14 md:gap-40 mb-10 md:mb-0'>
